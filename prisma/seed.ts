...
async function main() {
  ...
  await prisma.aboutInfo.upsert({
    ...
    create: {
      ...
      heroSub: "Full Stack Developer|UI/UX Designer|Open Source Enthusiast",
      avatarUrl: "",
      resumeUrl: "#",
    },
  });
  ...
  const projects = [
    {
      ...
      longDesc: "Built a complete e-commerce platform with product management, cart functionality, Stripe payments, and an admin dashboard.",
      category: "Full Stack",
      date: "2024-01",
    ...
    },
    {
      ...
      longDesc: "An intelligent task management application that uses OpenAI to automatically prioritize tasks, suggest deadlines, and generate subtasks.",
      category: "Web App",
      date: "2024-03",
      projectUrl: "https://example.com",
      githubUrl: "https://github.com",
    ...
    },
    {
      ...
      longDesc: "A scalable real-time chat application supporting thousands of concurrent users with rooms, direct messages, and file sharing.",
      category: "Full Stack",
      date: "2023-11",
      projectUrl: "https://example.com",
      githubUrl: "https://github.com",
    ...
    },
    {
      ...
      longDesc: "Created a fully documented component library with 50+ accessible React components following WCAG 2.1 guidelines.",
      category: "UI/UX",
      date: "2023-08",
      projectUrl: "https://example.com",
      githubUrl: "https://github.com",
